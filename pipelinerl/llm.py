...
class LLMCall(BaseModel):
    ...
    Attributes:
        ...
        prompt_token_ids (list[int] | None): Exact prompt IDs used by inference.
        output_token_ids (list[int] | None): Exact completion IDs sampled by inference.
    ...
    prompt_token_ids: list[int] | None = Field(default=None, exclude=True)
    output_token_ids: list[int] | None = Field(default=None, exclude=True)
    cached: bool
