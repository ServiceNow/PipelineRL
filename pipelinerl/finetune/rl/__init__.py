...
class RLConfig(BaseModel):
    ...
    epsilon_low: float = Field(default=0.2, description="Clip parameter for the lower bound of the ratio of log probs")
    epsilon_high: float = Field(default=0.28, description="Clip parameter for the upper bound of the ratio of log probs")
