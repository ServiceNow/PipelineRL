...
async def _run_privacy_hopqa_rollout_async(
    ...
    metrics = PrivacyHopQAMetrics(
        ...
        searches_total=searches_total,
        docs_read=docs_read,
        candidate_windows_before_parent_trim=retrieval_summary.get("candidate_windows_before_parent_trim", 0),
        candidate_windows_after_parent_trim=retrieval_summary.get("candidate_windows_after_parent_trim", 0),
        candidate_parent_docs_before_parent_trim=retrieval_summary.get("candidate_parent_docs_before_parent_trim", 0),
        candidate_parent_docs_after_parent_trim=retrieval_summary.get("candidate_parent_docs_after_parent_trim", 0),
        selected_parent_docs=retrieval_summary.get("selected_parent_docs", 0),
        selected_parent_windows_available=retrieval_summary.get("selected_parent_windows_available", 0),
        selected_windows_read=retrieval_summary.get("selected_windows_read", 0),
        selected_window_read_ratio=retrieval_summary.get("selected_window_read_ratio", 0.0),
        large_parent_docs_selected=retrieval_summary.get("large_parent_docs_selected", 0),
        large_parent_docs_limited=retrieval_summary.get("large_parent_docs_limited", 0),
        large_parent_windows_available=retrieval_summary.get("large_parent_windows_available", 0),
        large_parent_windows_read=retrieval_summary.get("large_parent_windows_read", 0),
        large_parent_window_read_ratio=retrieval_summary.get("large_parent_window_read_ratio", 0.0),
        max_selected_parent_windows_available=retrieval_summary.get("max_selected_parent_windows_available", 0),
        max_selected_parent_windows_read=retrieval_summary.get("max_selected_parent_windows_read", 0),
        gold_parent_hops=retrieval_summary.get("gold_parent_hops", 0),
        gold_parent_retrieved_before_trim_hops=retrieval_summary.get("gold_parent_retrieved_before_trim_hops", 0),
        gold_parent_retrieved_hops=retrieval_summary.get("gold_parent_retrieved_hops", 0),
        gold_parent_read_hops=retrieval_summary.get("gold_parent_read_hops", 0),
        gold_parent_retrieved_before_trim_rate=retrieval_summary.get("gold_parent_retrieved_before_trim_rate", 0.0),
        gold_parent_retrieved_rate=retrieval_summary.get("gold_parent_retrieved_rate", 0.0),
        gold_parent_read_rate=retrieval_summary.get("gold_parent_read_rate", 0.0),
        gold_parent_missed_after_trim_hops=retrieval_summary.get("gold_parent_missed_after_trim_hops", 0),
        gold_parent_retrieved_not_read_hops=retrieval_summary.get("gold_parent_retrieved_not_read_hops", 0),
        ...
        parse_errors_total=error_summary.get("parse_errors_total", 0),
        context_overflow_errors=error_summary.get("context_overflow_errors", 0),
        hop_plan_parse_errors=error_summary.get("parse_errors_by_stage", {}).get("hop_plan", 0),
