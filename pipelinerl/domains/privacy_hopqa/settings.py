...
class PrivacyHopQASettings:
    ...
    hop_plan_max_tokens: int = 1024
    doc_choose_max_tokens: int = 1024
    doc_read_max_tokens: int = 768
    hop_resolve_max_tokens: int = 1024
    ...
    def from_cfg(cls, cfg: DictConfig | Mapping[str, Any] | None) -> "PrivacyHopQASettings":
        ...
        return cls(
            ...
            hop_plan_max_tokens=int(data.get("hop_plan_max_tokens", 1024)),
            doc_choose_max_tokens=int(data.get("doc_choose_max_tokens", 1024)),
            doc_read_max_tokens=int(data.get("doc_read_max_tokens", 768)),
            hop_resolve_max_tokens=int(data.get("hop_resolve_max_tokens", 1024)),
